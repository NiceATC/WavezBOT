...
/**
 * @typedef {{ token: string, expiresAt: string, botUserId: string|null, botName: string|null, actorRole: string|null, permissions?: string[] }} StoredToken
 */
 ...
 * @param {{ token: string, expiresAt: string, botUserId?: string, botName?: string, actorRole?: string, permissions?: string[] }} tokenData
 */
