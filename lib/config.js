...
export function loadConfig() {
  ...
  return {
    ...
    commandBlacklistUserIds: jStrArr("commandBlacklistUserIds", []),
    ...
    motdDeleteMs: jInt("motdDeleteMs", 180_000),
    intervalMessages: jArr("intervalMessages", []),
    messageInterval: jInt("messageInterval", 5),

    // ── Startup/online announcement ────────────────────────────────────
    onlineAnnouncementDeleteMs: jInt("onlineAnnouncementDeleteMs", 30_000),
    ...
    rouletteMessageDeleteMs: jInt("fun.rouletteMessageDeleteMs", 180_000),
    funNeutralEnabled: jBool("fun.neutralEnabled", true),
    ...
    liveEventsResultDeleteMs: jInt("fun.liveEventsResultDeleteMs", 30_000),
  };
}
